...
class TBacbo implements IDoublePlataforma
{
    ...
    public function buscar_sinais($param){
        ...
        try {
            $client = new Client("wss://aleaplay.evo-games.com/public/bacbo/player/game/BacBo00000000001/socket?messageFormat=json&tableConfig=rkg33642manu66ci&EVOSESSIONID=sicprah7yajqabccsicpvoajq3rqoi44a409dab775248d1514c0ce1aa2100c4a9151603188b09d26&instance=4jr8pb-sicprah7yajqabcc-rkg33642manu66ci&client_version=6.20240917.72855.44625-d82fc7ab5d");
        
            $client->send('{"id":"o211lltxpj","type":"settings.read","args":{"keys":["generic.common","generic.mobile","generic.phone","generic.tablet","bacbo.common"]}}');
            while (true) {
                try {
