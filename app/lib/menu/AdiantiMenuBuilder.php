        ...
        if (file_exists($file))
        {
            ...
            foreach ($xml as $xmlElement)
            {
                ...
                if ($xmlElement->menu)
                {
                    ...
                    if (!empty((string) $xmlElement-> desktop) && (string) $xmlElement-> desktop == 'N')
                    {
                        $dropdown->setButtonClass('dropdown-toggle btn superlight hide-desktop');
                    }
                    ...
                    foreach ($xmlElement->menu->menuitem as $menuItem)
                    {
                        ...
                        if (self::checkMenuActionPermission($item_action))
                        {
                            ...
                            if (!empty((string) $menuItem-> desktop) && (string) $menuItem-> desktop == 'N')
                            {
