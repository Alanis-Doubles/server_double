...
final class CreateStatusUser extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        $this->table('arbety_user')
            ->addColumn('status_robo', 'enum', ['values' => ['PARADO','INICIANDO', 'EXECUTANDO', 'PARANDO'], 'default' => 'PARADO', 'null' => false])
